...
public:
    ...
    WidgetPtr build(BuildContext& ctx) override {
        ...
        auto wrap1 = std::make_shared<FlexBox>(); wrap1->padding(Edge::All, 15).child(item1);
        auto wrap2 = std::make_shared<FlexBox>(); wrap2->padding(Edge::All, 15).child(item2);
        auto wrap3 = std::make_shared<FlexBox>(); wrap3->padding(Edge::All, 15).child(item3);
